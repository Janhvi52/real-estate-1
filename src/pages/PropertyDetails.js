          ...
          <div className="flex-1 bg-white-100 w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
            ...
            <form className="flex flex-col gap-y-4">
              ...
              <input
                ...
                placeholder="Phone*"
              />
              <textarea className="border border-gray-300 focus:border-violet-700 outline-none realize-none rounded w-full p-4 h-36 text-sm text-gray-400"
              placeholder="Message*"
              defaultValue="Hello, Count me in!"></textarea>
